...
const ProjectMarketplace = () => {
  ...
  id: 26,
  title: 'Library Management System',
  description: 'A desktop app to manage book inventory and member records.',
  price: 2999,
